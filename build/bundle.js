...
/******/ 	__webpack_require__.p = "/Users/chiou_chu/chiou/Demo/SurveyForm/build";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _index5 = __webpack_require__(167);
	...
	var App = function (_PureComponent) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            // TODOS: load json to generate form
	            // console.log(require('JSON/survey.json'));
	            //
	            // TODOS:
	            // 先做好每個component
	            // 加上RWD
	            ...
	            var list = surveyList.survey.map(function (itm, idx) {
	                return _this2._renderQuestion(itm, idx);
	            });
	        ...
	        key: '_renderQuestion',
	        value: function _renderQuestion(item, idx) {
	            var pros = {
	                id: idx,
	                key: idx,
	                item: item,
	            ...
	            switch (item.type) {
	                case 'radio':
	                    return _react2.default.createElement(_index2.default, pros);
	                case 'checkbox':
	                    return _react2.default.createElement(_index4.default, pros);
	                case 'text':
	                    return _react2.default.createElement(_index6.default, pros);
	                case 'textarea':
	                    return _react2.default.createElement(_index8.default, pros);
	                case 'select':
	                    return _react2.default.createElement(_index10.default, pros);
	                default:
	                    return _react2.default.createElement(
	                        'div',
	                        { key: idx },
	                        'Can\'t find the survey component: ',
	                        item.type
	                    );
	            }
	        }
	        ...
	        key: '_onChangeHandle',
	        value: function _onChangeHandle(e) {
	            // TODOS: record the answer
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Radio = function (_PureComponent) {
	    ...
	    _createClass(Radio, [{
	        ...
	        key: '_renderRadioItem',
	        value: function _renderRadioItem() {
	            var _props2 = this.props;
	            var id = _props2.id;
	            var item = _props2.item;
	            var onChangeHandle = _props2.onChangeHandle;

	            var items = item.data.map(function (itm, idx) {
	                var inputID = 'radio_' + id + '_' + idx;
	                var val = itm.value ? itm.value : itm.label;
	                var label = itm.label;
	                return _react2.default.createElement(
	                    'div',
	                    {
	...
	Radio.PropTypes = {
	    ...
	    onChangeHandle: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Question = function (_PureComponent) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Checkbox = function (_PureComponent) {
	    ...
	    _createClass(Checkbox, [{
	        ...
	        value: function _renderCheckboxItem() {
	            var _props2 = this.props;
	            var id = _props2.id;
	            var item = _props2.item;
	            var onChangeHandle = _props2.onChangeHandle;
	            ...
	            var items = item.data.map(function (itm, idx) {
	                var inputID = 'checkbox_' + id + '_' + idx;
	                var val = itm.value ? itm.value : itm.label;
	                var label = itm.label;
	                return _react2.default.createElement(
	                    'div',
	...
	var Text = function (_PureComponent) {
	    ...
	    _createClass(Text, [{
	        ...
	        value: function render() {
	            ...
	            var id = _props.id;
	            var item = _props.item;
	            var onChangeHandle = _props.onChangeHandle;
	...
	var Textarea = function (_PureComponent) {
	    ...
	    _createClass(Textarea, [{
	        ...
	        value: function render() {
	            ...
	            var rows = item.rows ? item.rows : 3;
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_index2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Select = function (_PureComponent) {
	    ...
	    function Select(props) {
	        ...
	        _this._onToggleOpen = _this._onToggleOpen.bind(_this);
	        _this._onClickCallback = _this._onClickCallback.bind(_this);
	    ...
	    _createClass(Select, [{
	        ...
	        value: function render() {
	            ...
	            var selectedItem = item.data.find(function (obj) {
	                return obj.value === _this2.state.selectedValue;
	            });
	            return _react2.default.createElement(
	                'div',
	                null,
	                ...
	                _react2.default.createElement(
	                    'div',
	                    {
	                        className: (0, _classnames2.default)(selectClass),
	        ...
	        key: '_renderSelectItem',
	        value: function _renderSelectItem() {
	            var _this3 = this;
	            ...
	            var items = item.data.map(function (itm, idx) {
	                var inputID = 'select_' + id + '_' + idx;
	                var val = itm.value ? itm.value : itm.label;
	                var label = itm.label;
	                var optClass = {
	                    selectItem: true,
	                    selected: _this3.state.selectedValue === val
	                };
	                return _react2.default.createElement(
	                    'li',
	                    {
	                        className: (0, _classnames2.default)(optClass),
	                        key: idx,
	                        id: inputID,
	                        'data-value': val,
	                        onClick: _this3._onClickCallback
	                    },
	                    _react2.default.createElement(
	                        'span',
	                        null,
	        ...
	        key: '_onToggleOpen',
	        value: function _onToggleOpen() {
	            this.setState({
	                isOpen: !this.state.isOpen
	            });
	        }
	    }, {
	        key: '_onClickCallback',
	        value: function _onClickCallback(e) {
	            this.setState({
	                isOpen: false,
		...
		"survey": [
			...
			},
			{
				...
				"data": [
					...
					{
						"value": "7",
						"label": "option label 7"
					},
					{
						"value": "8",
						"label": "option label 8"
					},
					{
						"value": "9",
						"label": "option label 9"
					},
					{
						"value": "10",
						"label": "option label 10"
					}
				]
			},
			{
